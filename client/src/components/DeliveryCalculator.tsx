      ...
      <div className="max-w-2xl mx-auto">
        ...
        >
          ...
          <div className="space-y-2 text-sm">
            ...
            <div className="flex justify-between">
              <span className="text-gray-400">3 - 8 km</span>
              <span className="text-[#F59E0B] font-bold">R$ 5,00 + R$ 1,80/km</span>
            </div>
            <div className="flex justify-between">
              <span className="text-gray-400">8 - 15 km</span>
              <span className="text-[#DC2626] font-bold">R$ 8,00 + R$ 1,80/km</span>
            </div>
